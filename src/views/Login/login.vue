<template>
    <div class="flex justify-center items-center h-screen">
        ...
        <div class="w-3/5 md:w-1/2 lg:w-1/3 h-3/10 bg-slate-50 box-border p-8 shadow-md rounded-md">
            ...
            <n-form ref="formRef" :model="model" :rules="rules">
                ...
                <div class="flex flex-col justify-around items-center h-16">
                    <div>
                        <n-button :disabled="model.account === null" round type="primary" class="w-24"
